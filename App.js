...
[
    ...
    { id: 2, nombre: 'Iphone', precio: 4000},
    { id: 3, nombre: 'Teclado', precio: 3500}
];

//GET para mostrar un id en especifico
app.get('/productos/:id', (req, res) => //req: request lo que el cliente manda y res: lo que nos devuelve
{
